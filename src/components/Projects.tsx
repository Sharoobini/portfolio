  ...
  const projects: Project[] = [
    {
      ...
      githubName: 'AI-Powered-Guide-Sustainable-Tourism',
  ...
  return (
    <section ref={ref} className="py-24 px-4 sm:px-6 lg:px-8 relative max-w-[1600px] mx-auto">
      ...
      <div className="relative z-10">
        ...
        <motion.div 
          className="mb-10 flex flex-col md:flex-row gap-4 items-center justify-between bg-slate-900/60 backdrop-blur-xl p-3 sm:p-4 rounded-3xl border border-purple-500/20 shadow-2xl shadow-purple-950/40"
        ...
        >
          ...
          <div className="relative w-full md:w-72">
            ...
            <input
              ...
              className="w-full pl-10 pr-9 py-2 bg-purple-950/40 border border-purple-500/30 rounded-2xl text-white text-xs sm:text-sm placeholder-purple-300/40 focus:outline-none focus:border-fuchsia-500 focus:ring-2 focus:ring-fuchsia-500/30 transition-all duration-300"
            />
            {searchQuery && (
              <button
        ...
        {/* 5-Column Grid Layout on XL screens */}
        <motion.div
          layout
          className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4.5"
        >
          <AnimatePresence mode="popLayout">
            {filteredProjects.map((project, index) => (
              ...
              >
                <div className="relative flex flex-col h-full bg-slate-900/70 backdrop-blur-md rounded-2xl border border-purple-500/20 hover:border-fuchsia-500/50 transition-all duration-300 hover:-translate-y-1.5 hover:shadow-xl hover:shadow-fuchsia-950/50 overflow-hidden">
                  ...
                  <div className="relative h-36 overflow-hidden bg-purple-950/40">
                    ...
                    {/* Category Pill */}
                    <span className="absolute top-2.5 left-2.5 px-2.5 py-0.5 bg-slate-950/80 backdrop-blur-md rounded-full text-[10px] font-semibold text-fuchsia-300 border border-fuchsia-500/30 shadow-md">
                      {project.category}
                    </span>
                    ...
                    <motion.a
                      ...
                      className="absolute top-2.5 right-2.5 p-1.5 bg-slate-950/80 backdrop-blur-md rounded-xl text-purple-200 hover:text-white hover:bg-fuchsia-600 transition-all border border-white/10"
                  ...
                  <div className="p-4 flex flex-col flex-grow justify-between">
                    <div>
                      ...
                      <div className="flex items-center justify-between gap-1 mb-1">
                        <h3 className="text-white text-sm font-bold truncate group-hover:text-fuchsia-300 transition-colors">
                          {project.name}
                        </h3>
                      </div>

                      {/* GitHub Repo Handle */}
                      <code className="block text-[11px] font-mono text-purple-400/90 mb-2 truncate bg-purple-950/50 px-2 py-0.5 rounded border border-purple-500/20">
                        {project.githubName}
                      </code>

                      {/* Description */}
                      <p className="text-purple-200/70 text-xs line-clamp-3 leading-relaxed mb-4">
                        {project.description}
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-1 mb-3">
                        {project.tech.map((t) => (
                          <span
                            key={t}
                            className="px-2 py-0.5 bg-purple-900/30 backdrop-blur-sm rounded-md text-[10px] font-medium text-purple-300 border border-purple-500/20"
                          >
                            {t}
                          </span>
                        ))}
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center justify-between w-full pt-2.5 border-t border-purple-500/15 text-[11px] font-semibold text-fuchsia-400 group-hover:text-pink-300 transition-colors"
                      >
